...
namespace ClienteWeb.Pages.WasteTraceability.RegisterWasteTransportRecord
{
    ...
    public class TransportConfirmModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostConfirmarTransporteAsync()
        {
            if (Servicio == null || string.IsNullOrWhiteSpace(Servicio.Id))
            {
                TempData["MensajeError"] = "No se identificó el servicio para iniciar transporte.";
            ...
            try
            {
                ...
                var requestUrl = $"{ServiciosApiUrl}/{Uri.EscapeDataString(Servicio.Id)}/iniciar-transporte";
            ...
            {
                TempData["MensajeError"] = "Ocurrió un error al iniciar el transporte.";
                return RedirectToPage("../RegisterWasteCollection/IndexRegisterWasteCollection");
            }
        }
